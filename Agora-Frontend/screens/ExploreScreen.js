...
//            setCurrentBanner(banners[randomIndex]);
    ...
    return (<SafeAreaView style={styles.container}>
        ...
        <Animated.ScrollView
            ...
            />}
        >
            {loading && !refreshing ? (renderLoadingState()) : error ? (renderErrorState()) : items.length === 0 ? (renderEmptyState()) : (<>
                {/* Header */}
                <View style={styles.header}>
                    <View>
                        <DynamicHeader/>
                ...
                <View style={styles.section}>
                    ...
                    {collegeItems.length > 0 ? (<Animated.ScrollView
                        horizontal
                        showsHorizontalScrollIndicator={false}
                        contentContainerStyle={styles.horizontalList}
                    >
                        ...
                        <Text style={styles.emptySectionText}>
                            {currentUser?.id ? 'No listings from your college yet.' : 'Log in to see listings from your college.'}
                        </Text>
                    </View>)}
                </View>
...
const styles = StyleSheet.create({
    ...
    searchSection: {
        ...
        marginTop: THEME.spacing.sectionGap, paddingHorizontal: THEME.spacing.screenPadding,
    }, sectionHeader: {
        ...
        fontSize: THEME.fontSize.sm, color: COLORS.dark.textTertiary, fontWeight: THEME.fontWeight.semibold,
    }, categoriesContainer: {
        paddingRight: THEME.spacing.screenPadding,
    }, horizontalList: {
        paddingRight: THEME.spacing.screenPadding, paddingBottom: THEME.spacing[2],
    }, exploreGrid: {
        flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between',
    }, showAllContainer: {
        width: '100%', alignItems: 'center', paddingVertical: THEME.spacing.lg, marginTop: THEME.spacing.sm,
    }, showAllButton: {
        flexDirection: 'row',
        alignItems: 'center',
        ...
        fontSize: THEME.fontSize.sm, fontWeight: THEME.fontWeight.semibold, color: COLORS.primary,
    },

    // Skeleton Styles
    skeletonBanner: {
        width: '100%', height: 160, backgroundColor: COLORS.dark.cardElevated, borderRadius: THEME.borderRadius.card,
    }, skeletonCard: {
        width: '48%',
        ...
        width: '100%', aspectRatio: 1, backgroundColor: COLORS.dark.cardElevated,
    }, skeletonContent: {
        ...
        height: 14, width: '60%', backgroundColor: COLORS.dark.cardElevated, borderRadius: THEME.borderRadius.xs,
    }, skeletonFeatured: {
        width: 180,
        ...
        width: '100%', height: 180, backgroundColor: COLORS.dark.cardElevated,
        ...
        width: 140, height: 140, backgroundColor: COLORS.dark.cardElevated,
    }, skeletonNearestContent: {
        flex: 1, padding: THEME.spacing.itemGap, justifyContent: 'space-between',
        ...
        height: 12, width: '40%', backgroundColor: COLORS.dark.cardElevated, borderRadius: THEME.borderRadius.xs,
    },

    greeting: {
        fontSize: THEME.fontSize.xl, fontWeight: THEME.fontWeight.bold, color: COLORS.dark.text,
    }, subGreeting: {
        fontSize: THEME.fontSize.base, color: COLORS.dark.textSecondary, marginTop: THEME.spacing[1],
    },
    ...
    emptyState: {
        ...
        borderRadius: THEME.borderRadius.button, ...THEME.shadows.md,
    }, emptyButtonText: {
        color: COLORS.white, fontSize: THEME.fontSize.base, fontWeight: THEME.fontWeight.bold,
    },
